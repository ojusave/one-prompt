...
export const VIDEO_TASK_LABELS = {
  ...
  inspectService: "Inspect checkout service",
  searchRetry: "Search retry configuration",
  inspectOrder: "Inspect order creation",
  readTests: "Read relevant tests",
  hypothesis: "Form hypothesis",
  reproduce: "Reproduce duplicate orders",
  proposeFix: "Propose idempotency guard",
  applyPatch: "Apply patch",
  runTests: "Run checkout tests",
  deploy: "Deploy preview on Render",
  verify: "Verify behavior",
  checkpoint: "Completed work preserved",
