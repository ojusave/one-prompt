...
export const VIDEO_TASK_LABELS = {
  ...
  plan: "Map execution graph",
  inspectService: "Trace checkout entrypoints",
  searchRetry: "Find retry policy + backoff",
  inspectOrder: "Audit order write path",
  readTests: "Check failing test coverage",
  hypothesis: "Form root-cause hypothesis",
  reproduce: "Replay duplicate-order scenario",
  proposeFix: "Design idempotency guard",
  applyPatch: "Apply guarded write patch",
  runTests: "Run checkout + retry suite",
  deploy: "Ship preview to Render",
  verify: "Verify repeated requests",
  checkpoint: "Snapshot completed work",
  retry: "Retry verification step",
